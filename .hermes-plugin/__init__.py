...
them on demand via:
    ...
    skill_view("ai-commerce-agent-toolkit:<skill-name>")
"""
...
# the ai-commerce-agent-toolkit repo. install.sh symlinks .hermes-plugin/ into
...
def register(ctx) -> None:
    ...
    logger.info("ai-commerce-agent-toolkit: registered %d skills", len(skills))
